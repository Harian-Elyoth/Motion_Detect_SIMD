...
void bench_mouvement_SIMD_car(){
	...
	// FULL
	CHRONO(SigmaDelta_simd_full(vmi0, vmi1, vmj0, vmj1, image, mean0, std0, img_bin), cycles_total_full);
...
void bench_mouvement_SIMD_dataset(type_sd_t TYPE_SD, type_opti_t TYPE_OPTI){
	...
	double cycles_step4 = 0, cycles_step4_mean = 0, cycles_step4_opti = 0, cycles_step4_opti_mean = 0;
   	...
   	double cycles_total_full_opti_omp = 0, cycles_total_full_opti_mean_omp = 0;
	...
	double time_total_full_opti_omp = 0, time_total_full_opti_mean_omp = 0;
	...
	double debit_total_full_opti_omp = 0, debit_total_full_opti_mean_omp = 0;
	    	...
	    	case SD_FULL:
	    		switch(TYPE_OPTI)
	    		{
	    			...
	    			case SIMD_OMP:
	    				...
	    				// FULL OPTI OPEN MP
						CHRONO(SigmaDelta_simd_full_opti_openMP(vmi0, vmi1, vmj0, vmj1, image, mean0, std0, img_bin), cycles_total_full_opti_omp);
